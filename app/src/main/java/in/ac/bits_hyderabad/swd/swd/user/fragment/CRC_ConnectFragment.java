...
public class CRC_ConnectFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_crc__connect, container, false);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        swipeRefresh=view.findViewById(R.id.swipeRefreshCRC);
        swipeRefresh.setRefreshing(true);

        personCRC =new ArrayList<>();
        rvCRC=view.findViewById(R.id.rvCRC);
                ...
                try {
                    ...
                    for(int i=0;i<jsonArray.length();i++)
                    {
                        ...
                        if(obj.getString("heading").equals("Corroboration and Review Committee"))
                        {
                            ...
                            personCRC.add(new Person(name,designation,phone,uid,heading,subheading));
